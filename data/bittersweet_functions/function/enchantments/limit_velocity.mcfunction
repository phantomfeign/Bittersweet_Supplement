...
execute store result score @s ArrowYVelocity run data get entity @s Motion[1] 1000
...
scoreboard players operation @s ArrowYVelocity *= #70 Percent
scoreboard players operation @s ArrowYVelocity /= #100 Percent
...
execute store result entity @s Motion[1] double 0.001 run scoreboard players get @s ArrowYVelocity
