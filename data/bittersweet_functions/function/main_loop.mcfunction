...
execute as @e[type=item] at @s if items entity @s contents minecraft:golden_helmet run function bittersweet_functions:check_gold
execute as @e[type=item] at @s if items entity @s contents minecraft:golden_chestplate run function bittersweet_functions:check_gold
execute as @e[type=item] at @s if items entity @s contents minecraft:golden_leggings run function bittersweet_functions:check_gold
execute as @e[type=item] at @s if items entity @s contents minecraft:golden_boots run function bittersweet_functions:check_gold

execute as @e[type=item] at @s if items entity @s contents minecraft:golden_sword run function bittersweet_functions:check_gold
execute as @e[type=item] at @s if items entity @s contents minecraft:golden_pickaxe run function bittersweet_functions:check_gold
execute as @e[type=item] at @s if items entity @s contents minecraft:golden_axe run function bittersweet_functions:check_gold
