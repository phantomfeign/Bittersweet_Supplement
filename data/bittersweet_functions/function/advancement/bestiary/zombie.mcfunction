...
author:"phantomfeign",\
pages:[{"text":"\
Zombies are a remarkable example of the Night Terror's influence. \
Their instinct driven relentlessness is a twisted reflection of humanity's endurance, both emotionally and physically. \
"},\
{"text":"\
They gather in greater numbers after repeated nights of troubled sleep, as all undead do. \
