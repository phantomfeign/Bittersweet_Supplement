...
effect give @a[distance=1.1..2] minecraft:poison 8 4
effect give @a[distance=2.1..3] minecraft:poison 6 4
effect give @a[distance=3.1..4] minecraft:poison 4 4
effect give @a[distance=4.1..5] minecraft:poison 3 4
effect give @a[distance=5.1..6] minecraft:poison 2 4
